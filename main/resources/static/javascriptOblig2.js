...
function hentA() {
    $.get( "/hentAlle", function( billetter ) {                           <!--Kaller hentAlle fra server, fikk den ikke inn av output derfor denne løsningen-->
        formaterData2(billetter);
    });

function formaterData2(billetter){
    $("#fornavn").text("OY")
...
function output(){
    ...
    if(ok === 6){
        ...
        $.get("/lagre", billett, function(){                         <!--Kaller /lagre fra server-->
            hentAlle();
        });
    ...
    function hentAlle() {
        $.get( "/hentAlle", function( data ) {                           <!--Kaller hentAlle fra server-->
            formaterData(data);
        });
    }
